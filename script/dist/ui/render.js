...
import { firstFavoriteButton, secondFavoriteButton, thirdFavoriteButton, pokemonNumber, pokemonName, pokemonImage, pokemonNameOrIdInput } from "../dom/elements.js";
...
export const renderPokemon = async (pokemonNameOrID) => {
    try {
